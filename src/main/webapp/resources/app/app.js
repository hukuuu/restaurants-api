...
angular.module('myApp', [
    ...
    .config(["$routeProvider", "$httpProvider", function ($routeProvider, $httpProvider) {
        ...
        $routeProvider.when('/restaurants', {
            ...
            resolve: {
                restaurants : ["RestaurantsService", function (RestaurantsService) {
        ...
        $routeProvider.when('/restaurants/view/:id', {
            ...
            resolve: {
                restaurant: ["$route", "RestaurantsService", function ($route, RestaurantsService) {
        ...
        $routeProvider.when('/restaurants/view/:restaurantId/food', {
            ...
            resolve: {
                food: ["$route", "FoodServiceProvider", function ($route, FoodServiceProvider) {
...
angular.module('config')
  ...
  .constant('baseUrl','http://restaurants-hukuuu.rhcloud.com/restaurants/api/')
  .constant('baseImgUrl', 'http://restaurants-hukuuu.rhcloud.com/restaurants/resources/images');
...
angular.module('food')
    .controller('FoodController', ["$scope", "$routeParams", "baseImgUrl", "food", "FoodServiceProvider", function ($scope, $routeParams, baseImgUrl, food, FoodServiceProvider) {
...
angular.module('restaurants')
    .controller('NewRestaurantController', ["$scope", "$routeParams", "$location", "$timeout", "RestaurantsService", "toaster", function($scope, $routeParams, $location, $timeout, RestaurantsService, toaster) {
...
angular.module('restaurants')
    .controller('RestaurantsController', ["$scope", "$location", "restaurants", "RestaurantsService", function($scope, $location,restaurants, RestaurantsService) {
        // var fetch = function() {
...
angular.module('restaurants')
    .controller('ViewRestaurantController', ["$scope", "$routeParams", "$location", "$timeout", "restaurant", "RestaurantsService", "toaster", function($scope, $routeParams, $location, $timeout, restaurant, RestaurantsService, toaster) {
